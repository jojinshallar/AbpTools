...
using AbpProjectArchitectureGenerator.Core.Cores.TemplateDatas;
...
async Task<int> InitCommand(string[] args)
{
    ...
    var rootCommand = new RootCommand("AbpFramework项目架构实体文件快速生成工具");
...
//EmbbedArchGenerator.GenerateAsync("Helloworld", "Phone", new DirectoryInfo(AppDomain.CurrentDomain.BaseDirectory));